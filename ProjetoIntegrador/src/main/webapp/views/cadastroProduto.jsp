...
<table class="orange lighten-4">
	...
	<form id="form_produto" action="produtos" method="post">
		<input type="hidden" name="opcao" value="salvarProduto">
				...
				<td>
					<div class="input-field col s6">
						<i class="material-icons prefix">local_grocery_store</i> <input
							...
							class="validate" campo-obrigatorio size="300" name="nomeProduto">
				...
				<td>
					<div class="input-field col s6">
						<i class="material-icons prefix">monetization_on</i> <input
							...
							class="validate" campo-obrigatorio name="preco"> <label for="preco_prefix">Preço
			...
			<tr>
				<td>
					...
					<i class="material-icons prefix">assignment</i>
						<select name="categoria" class="validate" campo-obrigatorio>
		...
		<div class="center-align">
		  <button class="btn-large waves-effect waves-light" type="submit" value="salvar" onclick="">Salvar
