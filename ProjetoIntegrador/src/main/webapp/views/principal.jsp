...
<div class="container">
	<table class="orange lighten-4">
	 	<tr>
	 		<td>
				<font size="3">
		 			Bem vindo(a) <c:out value="${sessionScope.usuario.primeiroNome}"/>, deseja fazer <a href="logout">Logout?</a>
	 			</font>
	 		</td>
	 	</tr>
	</table>
	...
	<table border="1">
		<tr>
			<td> <a class="waves-effect waves-light btn" href= "pedidos?opcao=criarPedido">Registrar um Pedido</a></td>
		</tr>
		<tr>
			<td> <a class="waves-effect waves-light btn" href= "pedidos?opcao=listar">Listar todos os Pedidos</a></td>
		</tr>
